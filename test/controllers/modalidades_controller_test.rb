...
class ModalidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create modalidade" do
    assert_difference('Modalidade.count') do
      post modalidades_url, params: { modalidade: { descricao: @modalidade.descricao, despesa: @modalidade.despesa, nome: @modalidade.nome, receita: @modalidade.receita } }
    end
  ...
  test "should update modalidade" do
    patch modalidade_url(@modalidade), params: { modalidade: { descricao: @modalidade.descricao, despesa: @modalidade.despesa, nome: @modalidade.nome, receita: @modalidade.receita } }
