...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { cpf: @fornecedor.cpf, email: @fornecedor.email, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cpf: @fornecedor.cpf, email: @fornecedor.email, nome: @fornecedor.nome, telefone: @fornecedor.telefone } }
