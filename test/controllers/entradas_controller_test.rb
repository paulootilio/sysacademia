...
class EntradasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entrada" do
    assert_difference('Entrada.count') do
      post entradas_url, params: { entrada: { cliente_id: @entrada.cliente_id, desconto: @entrada.desconto, descricao: @entrada.descricao, modalidade_id: @entrada.modalidade_id, plano_id: @entrada.plano_id, total: @entrada.total, valor: @entrada.valor } }
    end
  ...
  test "should update entrada" do
    patch entrada_url(@entrada), params: { entrada: { cliente_id: @entrada.cliente_id, desconto: @entrada.desconto, descricao: @entrada.descricao, modalidade_id: @entrada.modalidade_id, plano_id: @entrada.plano_id, total: @entrada.total, valor: @entrada.valor } }
