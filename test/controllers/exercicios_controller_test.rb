...
class ExerciciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exercicio" do
    assert_difference('Exercicio.count') do
      post exercicios_url, params: { exercicio: { carga: @exercicio.carga, nome: @exercicio.nome, rept: @exercicio.rept, serie: @exercicio.serie } }
    end
  ...
  test "should update exercicio" do
    patch exercicio_url(@exercicio), params: { exercicio: { carga: @exercicio.carga, nome: @exercicio.nome, rept: @exercicio.rept, serie: @exercicio.serie } }
