...
class PlanosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plano" do
    assert_difference('Plano.count') do
      post planos_url, params: { plano: { descricao: @plano.descricao, nome: @plano.nome, referente: @plano.referente, valor: @plano.valor } }
    end
  ...
  test "should update plano" do
    patch plano_url(@plano), params: { plano: { descricao: @plano.descricao, nome: @plano.nome, referente: @plano.referente, valor: @plano.valor } }
