...
class TreinosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treino" do
    assert_difference('Treino.count') do
      post treinos_url, params: { treino: { cliente_id: @treino.cliente_id, plano_id: @treino.plano_id } }
    end
  ...
  test "should update treino" do
    patch treino_url(@treino), params: { treino: { cliente_id: @treino.cliente_id, plano_id: @treino.plano_id } }
